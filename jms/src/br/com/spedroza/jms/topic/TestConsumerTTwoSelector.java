 ...
 * 
 */
public class TestConsumerTTwoSelector {
	...
	public static void main(String[] args) throws NamingException, JMSException {
		...
		/*
		 *  consumer to get the message from the queue using selector
		 *  the consumer will only consume the message in case the property ebook is set as false
		 */
		MessageConsumer consumer = session.createDurableSubscriber(destT, "assinatura-selector", "ebook is null OR ebook=false", false);
